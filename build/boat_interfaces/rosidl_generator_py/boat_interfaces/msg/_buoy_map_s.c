...
bool boat_interfaces__msg__buoy_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("boat_interfaces.msg._buoy_map.BuoyMap", full_classname_dest, 37) == 0);
  }
  boat_interfaces__msg__BuoyMap * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of BuoyMap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("boat_interfaces.msg._buoy_map");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BuoyMap");
