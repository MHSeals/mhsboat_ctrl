...
static const _BuoyCoordinates_type_support_symbol_names_t _BuoyCoordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, boat_interfaces, msg, BuoyCoordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, boat_interfaces, msg, BuoyCoordinates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, boat_interfaces, msg, BuoyCoordinates)() {
  return &::boat_interfaces::msg::rosidl_typesupport_c::BuoyCoordinates_message_type_support_handle;
}
