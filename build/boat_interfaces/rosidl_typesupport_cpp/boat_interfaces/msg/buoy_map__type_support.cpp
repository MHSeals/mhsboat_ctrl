...
static const _BuoyMap_type_support_symbol_names_t _BuoyMap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, boat_interfaces, msg, BuoyMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, boat_interfaces, msg, BuoyMap)),
  }
};
...
{
  return &::boat_interfaces::msg::rosidl_typesupport_cpp::BuoyMap_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, boat_interfaces, msg, BuoyMap)() {
  return get_message_type_support_handle<boat_interfaces::msg::BuoyMap>();
}
