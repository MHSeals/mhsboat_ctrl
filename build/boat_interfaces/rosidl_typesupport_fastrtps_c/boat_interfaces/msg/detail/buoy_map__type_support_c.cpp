...
#include "boat_interfaces/msg/detail/buoy_map__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // colors, types
#include "rosidl_runtime_c/string_functions.h"  // colors, types

// forward declare type support functions


using _BuoyMap__ros_msg_type = boat_interfaces__msg__BuoyMap;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BuoyMap__ros_msg_type * ros_message = static_cast<const _BuoyMap__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BuoyMap__ros_msg_type * ros_message = static_cast<_BuoyMap__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_boat_interfaces__msg__BuoyMap(
  const void * untyped_ros_message,
...
static uint32_t _BuoyMap__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_boat_interfaces__msg__BuoyMap(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_boat_interfaces
size_t max_serialized_size_boat_interfaces__msg__BuoyMap(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = boat_interfaces__msg__BuoyMap;
    is_plain =
      (
...
static size_t _BuoyMap__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_boat_interfaces__msg__BuoyMap(
...
static message_type_support_callbacks_t __callbacks_BuoyMap = {
  "boat_interfaces::msg",
  "BuoyMap",
...
static rosidl_message_type_support_t _BuoyMap__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, boat_interfaces, msg, BuoyMap)() {
  return &_BuoyMap__type_support;
}
