...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            # DLIO Odometry Node - COMMENTED OUT (requires Cube Orange IMU)
            # Node(
            ...
            #     ],
            # ),
            # DLIO Mapping Node - COMMENTED OUT (depends on DLIO odometry)
            # Node(
            #     package='direct_lidar_inertial_odometry',
            ...
            #     ],
            # ),
            # Launch IMU Filter Node - COMMENTED OUT (requires Cube Orange IMU)
            # Node(
            ...
            # ),
            # Launch Robot Localization Node - Keep this but it will only use ZED odometry
            Node(
