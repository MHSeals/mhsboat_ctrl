...
def main():
    ...
    os.system(f"wget '{v9}' -O /home/roboboat/roboboat_ws/src/mhsboat_ctrl/mhsboat_ctrl/v9.pt")
    os.system(f"wget '{v10}' -O /home/roboboat/roboboat_ws/src/mhsboat_ctrl/mhsboat_ctrl/v10.pt")
